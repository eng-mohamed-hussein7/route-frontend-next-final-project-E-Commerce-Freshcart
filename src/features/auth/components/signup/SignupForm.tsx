      ...
      <section className="Signup-Form p-10 space-y-8 bg-white rounded-xl shadow-xl">
        ...
        <form className="space-y-7" onSubmit={handleSubmit(onSubmit)}>
          <div className="name flex gap-1 flex-col">
            ...
            <input type="text" id="name" placeholder="Ali"  className="form-control" {...register("name")}/>
            {errors.name && <p className="text-red-500 mt-0.5">*{errors.name.message}</p>}
          </div>
          <div className="email flex gap-1 flex-col">
            <label htmlFor="email">Email*</label>
            <input type="email" id="email" placeholder="ali.route@gmail.com"  className="form-control" {...register("email")}/>
            {errors.email && <p className="text-red-500 mt-0.5">*{errors.email.message}</p>}
          </div>
          <div className="phone flex gap-1 flex-col">
            <label htmlFor="phone">Phone*</label>
            <input type="tel" id="phone" placeholder="+2 010 9751 4862" className="form-control" {...register("phone")}/>
          ...
          <div className="terms flex gap-2 items-center">
            <input type="checkbox" id="terms" className="accent-primary-600 size-4" {...register("terms")}/>
            <label htmlFor="terms">
            ...
            {errors.terms && <p className="text-red-500 -mt-5">*{errors.terms.message}</p>}
          <button type="submit" disabled={isSubmitting} className="btn w-full flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 text-white disabled:opacity-50 disabled:cursor-not-allowed">
            {isSubmitting ? (
              <>
