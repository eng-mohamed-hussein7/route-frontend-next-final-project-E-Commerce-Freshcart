          ...
          <aside className="w-full lg:w-72 shrink-0">
            <nav className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <ul className="p-2">
                <li>
                  <Link
                    className={`flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${path === "addresses" ? "bg-primary-50 text-primary-700" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"} w-full`}
                    href="/profile/addresses"
                  >
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-colors ${path === "addresses" ? "bg-primary-500 text-white" : "bg-gray-100 text-gray-500 group-hover:bg-gray-200"}`}>
                      <FontAwesomeIcon
                        icon={faLocationDot}
                        className="text-sm"
                      />
                    ...
                    <FontAwesomeIcon
                      icon={faChevronRight}
                      className={`text-xs transition-transform ${path === "addresses" ? "text-primary-500" : "text-gray-400"}`}
                      />
                  </Link>
                </li>
                <li>
                  ...
                  >
                    ...
                    <span className="font-medium flex-1">All Orders</span>
                    <FontAwesomeIcon
                      icon={faChevronRight}
